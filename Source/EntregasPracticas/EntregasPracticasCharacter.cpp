...
#include "TP2/InteractInterface.h"
...
void AEntregasPracticasCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Interact
		EnhancedInputComponent->BindAction(InteractAction, ETriggerEvent::Started, this, &AEntregasPracticasCharacter::InteractOtherActor);
	}
	else
	{
...
void AEntregasPracticasCharacter::NotifyActorEndOverlap(AActor* OtherActor)
{
	...
	if (OverlappingActor && OverlappingActor->Implements<UInteractInterface>())
	{
		IInteractInterface::Execute_BreakInteract(OverlappingActor, this);
	}
...
void AEntregasPracticasCharacter::InteractOtherActor()
{
	if (OverlappingActor && OverlappingActor->Implements<UInteractInterface>())
	{
